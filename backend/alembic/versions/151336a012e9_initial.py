...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('active', 'suspended', name='org_status'), server_default='active', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('active', 'inactive', name='department_status'), server_default='active', nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('admin', 'asset_manager', 'department_head', 'employee', name='user_role'), server_default='employee', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('active', 'inactive', name='asset_category_status'), server_default='active', nullable=False),
        sa.ForeignKeyConstraint(['org_id'], ['organizations.id']),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.Column('condition', sa.Enum('new', 'good', 'fair', 'poor', 'damaged', name='asset_condition'), server_default='good', nullable=False),
        sa.Column('location', sa.String(length=255), nullable=True),
        sa.Column('is_bookable', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('status', sa.Enum('available', 'allocated', 'reserved', 'under_maintenance', 'lost', 'retired', 'disposed', name='asset_status'), server_default='available', nullable=False),
        sa.Column('photo_url', sa.Text(), nullable=True),
        sa.Column('documents', postgresql.JSONB(astext_type=sa.Text()), server_default='[]', nullable=False),
        sa.Column('current_holder_type', sa.Enum('employee', 'department', name='holder_type'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('allocated_to_type', sa.Enum('employee', 'department', name='holder_type'), nullable=False),
        ...
        sa.Column('status', sa.Enum('active', 'returned', 'transferred', name='allocation_status'), server_default='active', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('to_holder_type', sa.Enum('employee', 'department', name='holder_type'), nullable=False),
        sa.Column('to_holder_id', sa.UUID(), nullable=False),
        sa.Column('status', sa.Enum('requested', 'approved', 'rejected', name='transfer_status'), server_default='requested', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('upcoming', 'ongoing', 'completed', 'cancelled', name='booking_status'), server_default='upcoming', nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('priority', sa.Enum('low', 'medium', 'high', 'critical', name='maintenance_priority'), server_default='medium', nullable=False),
        sa.Column('photo_url', sa.Text(), nullable=True),
        sa.Column('status', sa.Enum('pending', 'approved', 'rejected', 'technician_assigned', 'in_progress', 'resolved', name='maintenance_status'), server_default='pending', nullable=False),
        sa.Column('approved_by_id', sa.UUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('draft', 'in_progress', 'closed', name='audit_cycle_status'), server_default='draft', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('audit_cycle_id', sa.UUID(), nullable=False),
        sa.Column('asset_id', sa.UUID(), nullable=False),
        sa.Column('status', sa.Enum('pending', 'verified', 'missing', 'damaged', name='audit_item_status'), server_default='pending', nullable=False),
